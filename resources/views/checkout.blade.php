                    ...
                    <div id="qr_container" class="mb-3" style="display: none;">
                        <div class="alert alert-info">
                            ...
                            @php
                                ...
                                $transferContent = 'CAEKT - ' . $productNames;
                            @endphp
                            
                            <div class="text-center mb-3">
                                @php
                                    try {
                                        $qrData = isset($fakeQrData) && !empty($fakeQrData) ? $fakeQrData : $transferContent;
                            ...
                            <p class="mb-2"><small><strong>Ngân hàng ABC:</strong> 123456789</small></p>
                            <p class="mb-0"><small><strong>Nội dung chuyển:</strong> {{ $transferContent }}</small></p>
